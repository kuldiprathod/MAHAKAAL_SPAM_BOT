    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 6:
            ...
            try:
                ...
                await event.edit("𝐓𝐄𝐑𝐀 𝐁𝐀𝐀𝐏 𝐀𝐀 𝐑𝐀𝐇𝐀 𝐇𝐀𝐈 𝐁𝐒𝐃𝐊 🔥")
            except Exception as e:
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 7:
            ...
            try:
                ...
                await event.edit("𝐏𝐑𝐈𝐕𝐀𝐓𝐄 𝐌𝐀𝐈 𝐂𝐇𝐔𝐃𝐄𝐆𝐀 𝐀𝐀𝐉 𝐓𝐔 🔥")
            except Exception as e:
                await event.edit(str(e))   
        else:
            await e.reply(usage, parse_mode=None, link_preview=None )
...
async def _(e):
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 11:
            ...
            text = "𝐀𝐁 𝐁𝐎𝐋 𝐁𝐒𝐃𝐊 𝐓𝐄𝐑𝐀 𝐁𝐀𝐀𝐏 𝐇𝐔 𝐌𝐀𝐈 🔥👹"
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 12:
            ...
            try:
                ...
                pass
            text = "𝐉𝐀 𝐉𝐈𝐋𝐄 𝐀𝐀𝐏𝐍𝐄 𝐙𝐈𝐍𝐃𝐆𝐈 𝐁𝐒𝐃𝐊 👹"
            await e.reply(text, parse_mode=None, link_preview=None )
        elif e.reply_to_msg_id:             
            a = await e.get_reply_message()
            b = await e.client.get_entity(a.sender_id)
            ...
            try:
                ...
                pass
            text = "𝐉𝐀 𝐉𝐈𝐋𝐄 𝐀𝐀𝐏𝐍𝐄 𝐙𝐈𝐍𝐃𝐀𝐆𝐈 𝐁𝐒𝐃𝐊 👹"
            await e.reply(text, parse_mode=None, link_preview=None )
        else:
            await e.reply(usage, parse_mode=None, link_preview=None )
...
async def help(e):
    if e.sender_id in SMEX_USERS:
       text = "💫𝐌𝐀𝐇𝐀𝐊𝐀𝐀𝐋 𝐒𝐏𝐀𝐌 \n\n𝐔𝐓𝐀𝐈𝐋 𝐂𝐎𝐌𝐌𝐀𝐍𝐃:\n.ping\n.restart\n\n𝐔𝐒𝐄𝐑𝐁𝐎𝐓 𝐂𝐎𝐌𝐌𝐀𝐍𝐃:\n.bio\n.join\n.pjoin\n.leave\n\n𝐒𝐏𝐀𝐌 𝐂𝐎𝐌𝐌𝐀𝐍𝐃𝐒:\n.spam\n.delayspam\n.bigspam\n.raid\n.replyraid\n.dreplyraid\n\n\n𝙵𝙾𝚁 𝙼𝙾𝚁𝙴 𝙷𝙴𝙻𝙿 𝙹𝙾𝙸𝙽 @mahakalspamcontrolroom"
       await e.reply(text, parse_mode=None, link_preview=None )
...
text = """
CONGRATS🥳🥳🥳 YOUR FASTEST, SMOOTHEST AND POWERFUL MAHAKAALSPAM DEPLOYED SUCCESSFULLY """

print(text)
print("")
print("𝚈𝙾𝚄𝚁😈 𝙵𝙰𝚂𝚃 𝙰𝙽𝙳 𝚂𝙼𝙾𝙾𝚃𝙷 𝙼𝙰𝙷𝙰𝙺𝙰𝙻 𝚂𝙿𝙰𝙼 𝙱𝙾𝚃 𝙸𝚂 𝙳𝙴𝙿𝙻𝙾𝚈𝙴𝙳 𝙶𝙸𝙱 𝙿𝙰𝚁𝚃𝚈 𝙰𝙽𝙳 𝙴𝙽𝙹𝙾𝚈 𝚂𝙿𝙰𝙼 💫!!")
